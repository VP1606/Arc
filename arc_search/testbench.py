from bestway_handler import bestway_login, generate_bestway_drivers
from parfetts_handler import parfetts_login, generate_parfetts_drivers
# import importlib
# import os, sys
import time
...
start = time.time()
collection = generate_bestway_drivers()
end = time.time()

print(collection)
print(f"BW TIME TAKEN: {round((end-start), 4)}")

start = time.time()
collection = generate_parfetts_drivers()
end = time.time()

print(collection)
print(f"PF TIME TAKEN: {round((end-start), 4)}")